...
RUN pkg update && pkg install -y \
    ...
    py311-numpy py311-pillow py311-orjson \
...
ARG IMMICH_VERSION
ARG PACKAGES="python311 py311-numpy py311-pillow py311-orjson py311-pydantic2 py311-pydantic-settings py311-fastapi py311-uvicorn py311-gunicorn py311-huggingface-hub py311-tokenizers onnxruntime openblas"
